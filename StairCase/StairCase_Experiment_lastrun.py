...
expName = 'StairCase_Experiment'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Darsh Modi\\OneDrive\\Documents\\AU\\PSY310\\StairCase\\StairCase_Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Thank You for participating in the experiment.\n\nIn this experiment, if the stimuli displayed is tilted towards the left, press the key "Left Arrow Key", and if it is tilted towards the right, press the key "Right Arrow Key" on your keyboard.\n\nIn case you wish to exit the experiment in the middle, you can press the "esc" key.\n\nOnce you have read and understood the instructions, press "space" to start the experiment.',
        font='Arial',
    ...
    Staircase = data.StairHandler(startVal=10.0, extraInfo=expInfo,
        stepSizes=(10,5,2.5,1,0.5), stepType='log',
        nReversals=0.0, nTrials=75.0, 
        nUp=3.0, nDown=1.0,
    ...
    for thisStaircase in Staircase:
        ...
        while continueRoutine:
            ...
            if hasattr(thisStaircase, 'status') and thisStaircase.status == STOPPING:
                continueRoutine = False
            # get current time
            t = routineTimer.getTime()
            tThisFlip = win.getFutureFlipTime(clock=routineTimer)
        ...
        thisExp.addData('corrAns', correct_resp)
