...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Darsh Modi\\OneDrive\\Documents\\AU\\PSY310\\SignalDetection\\SignalDetection_Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome to the experiment!\n\nFor this experiment, you are supposed to press the "up arrow key" when the stimuli displayed is aligned straight, and the "down arrow key" when the stimuli is tilted.\n\nYou may exit the experiment at any point of time by pressing the "esc key".\n\nPress "space" to start the experiment.\n\n',
        font='Arial',
