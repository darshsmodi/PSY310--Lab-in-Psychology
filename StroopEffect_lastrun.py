...
expName = 'StroopEffect'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Darsh Modi\\OneDrive\\Documents\\AU\\PSY310\\StroopEffect\\StroopEffect_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Welcome to the experiment!\n\nThe experiment requires you to press the key "r" when the text is written in red and the key "b" when the text is written in blue.\n\nIn case you want to exit the experiment, you can press the "esc" key on the keyboard.\n\n\nYour identity in the experiment remains confidential.\n\nOnce you have read and understood the experiment, press "space" to start.',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, key_resp, text_4],
        )
        ...
        key_resp.rt = []
        _key_resp_allKeys = []
        text_4.setColor(colour, colorSpace='rgb')
        text_4.setText(word)
