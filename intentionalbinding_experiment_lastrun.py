...
expName = 'intentionalbinding_experiment'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Darsh Modi\\OneDrive\\Documents\\AU\\PSY310\\Intentional Binding\\intentionalbinding_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ConditionsFile_IntentionalBinding.csv'), 
        seed=None, 
    )
